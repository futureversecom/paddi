...
export interface MockBrainInterface extends utils.Interface {
  functions: {
    'approve(address,uint256)': FunctionFragment
    'balanceOf(address)': FunctionFragment
    'cidv0Hashes(uint256)': FunctionFragment
  ...
  decodeFunctionResult(functionFragment: 'cidv0Hashes', data: BytesLike): Result
...
export interface MockBrain extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this
  attach(addressOrName: string): this
  deployed(): Promise<this>

  interface: MockBrainInterface
