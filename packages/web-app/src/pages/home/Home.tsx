  ...
  return (
    <div>
      <Typography variant="h3">
        Welcome to Paddi powered <br /> by ASM protocol
      </Typography>
      <Box component="p" sx={{ maxWidth: '900px' }}>
        Curious about the experience of incorporating ASM Brains into video
        games? Then, allow me to introduce you to Paddi, powered by ASM Brains
      ...
      <CaveatBox component="div" title="Important caveats" sx={{ my: 4 }}>
        ...
        <Box component="p" sx={{ fontStyle: 'italic', color: '#7C7C7C' }}>
          This Paddi game is for demonstration purposes only. It&apos;s shining
          a light on what you can do with ASM Brains, how AI training works and
